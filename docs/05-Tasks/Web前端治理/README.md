...
- `docs/09-Deploy/Step5-高频页面迁移详细设计文档.md`

目标是把 Step 1 到 Step 5 的首批治理任务变成可以逐个执行、逐个提交、逐个验收的实施任务。
...
基于 `docs/09-Deploy/Step5-高频页面迁移详细设计文档.md` 与 `docs/09-Deploy/Step5-高频页面迁移Task拆解文档.md`，建议继续追加 Step 5 高频页面迁移任务：

28. `T28-TreeHole内容流桌面化验证.md`
29. `T29-Post搜索与标签流桌面化验证.md`
30. `T30-CanteenHome门户桌面化验证.md`
31. `T31-高频详情页桌面化二次验证.md`
32. `T32-Mailbox次级高频页桌面化验证.md`
33. `T33-个人列表页桌面化二次验证.md`
...
- `T28` 到 `T33` 负责高频页面首批桌面化迁移验证，先做代表页，再为后续模块级批量治理建立参照

暂不覆盖：

- Step 6 以后更大范围的模块级批量迁移与收尾治理
