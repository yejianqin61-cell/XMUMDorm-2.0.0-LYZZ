  ...
  return (
    <div className="about-alg-page">
      <Card as="div" className="about-alg-card">
        <h2 className="about-alg-title">Scoring Algorithm 评分算法说明</h2>

        <section className="about-alg-section" aria-label="English">
          ...
          <div className="about-alg-table-wrap">
            <table className="about-alg-table">
              ...
              <tbody>
                <tr><td>夯爆了 (Amazing)</td><td>10</td></tr>
                <tr><td>顶级 (Top-tier)</td><td>7</td></tr>
                <tr><td>人上人 (Solid)</td><td>4</td></tr>
                <tr><td>NPC</td><td>1</td></tr>
                <tr><td>拉完了 (Pass)</td><td>-1</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <ul className="about-alg-ul">
            ...
            <li>
              ...
              <ul className="about-alg-ul about-alg-ul-nested">
                <li>Counts: n1(夯爆了), n2(顶级), n3(人上人), n4(NPC), n5(拉完了).</li>
